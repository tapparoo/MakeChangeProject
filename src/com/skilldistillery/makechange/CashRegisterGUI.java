...
public class CashRegisterGUI {
	...
	CashRegisterGUI() {
		...
		hGroup.addGroup(layout.createParallelGroup().addComponent(inputTextBox1).addComponent(inputTextBox2)
				.addComponent(button));

		GroupLayout.SequentialGroup vGroup = layout.createSequentialGroup();
		vGroup.addGroup(
				layout.createParallelGroup(Alignment.BASELINE).addComponent(labelPrice).addComponent(inputTextBox1));
		vGroup.addGroup(
				layout.createParallelGroup(Alignment.BASELINE).addComponent(labelPayment).addComponent(inputTextBox2));
